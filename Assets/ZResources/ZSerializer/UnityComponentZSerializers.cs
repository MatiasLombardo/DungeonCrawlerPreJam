...
[System.Serializable]
public sealed class CanvasZSerializer : ZSerializer.Internal.ZSerializer {
    ...
    public System.Boolean enabled;
    public UnityEngine.HideFlags hideFlags;
    public CanvasZSerializer (string ZUID, string GOZUID) : base(ZUID, GOZUID) {
        var instance = ZSerializer.ZSerialize.idMap[ZSerializer.ZSerialize.CurrentGroupID][ZUID] as UnityEngine.Canvas;
        renderMode = instance.renderMode;
        scaleFactor = instance.scaleFactor;
        referencePixelsPerUnit = instance.referencePixelsPerUnit;
        overridePixelPerfect = instance.overridePixelPerfect;
        pixelPerfect = instance.pixelPerfect;
        planeDistance = instance.planeDistance;
        overrideSorting = instance.overrideSorting;
        sortingOrder = instance.sortingOrder;
        targetDisplay = instance.targetDisplay;
        sortingLayerID = instance.sortingLayerID;
        additionalShaderChannels = instance.additionalShaderChannels;
        sortingLayerName = instance.sortingLayerName;
        worldCamera = instance.worldCamera;
        normalizedSortingGridSize = instance.normalizedSortingGridSize;
        enabled = instance.enabled;
        hideFlags = instance.hideFlags;
        ZSerializerSettings.Instance.unityComponentDataList.FirstOrDefault(data => data.Type == typeof(UnityEngine.Canvas))?.OnSerialize?.Invoke(this, instance);
    }
    public override void RestoreValues(UnityEngine.Component component)
    {
        var instance = (UnityEngine.Canvas)component;
        instance.renderMode = renderMode;
        instance.scaleFactor = scaleFactor;
        instance.referencePixelsPerUnit = referencePixelsPerUnit;
        instance.overridePixelPerfect = overridePixelPerfect;
        instance.pixelPerfect = pixelPerfect;
        instance.planeDistance = planeDistance;
        instance.overrideSorting = overrideSorting;
        instance.sortingOrder = sortingOrder;
        instance.targetDisplay = targetDisplay;
        instance.sortingLayerID = sortingLayerID;
        instance.additionalShaderChannels = additionalShaderChannels;
        instance.sortingLayerName = sortingLayerName;
        instance.worldCamera = worldCamera;
        instance.normalizedSortingGridSize = normalizedSortingGridSize;
        instance.enabled = enabled;
        instance.hideFlags = hideFlags;
        ZSerializerSettings.Instance.unityComponentDataList.FirstOrDefault(data => data.Type == typeof(UnityEngine.Canvas))?.OnDeserialize?.Invoke(this, instance);
    }
}
}